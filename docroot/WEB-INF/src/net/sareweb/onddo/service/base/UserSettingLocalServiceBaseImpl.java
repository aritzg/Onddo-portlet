...
/**
 * The base implementation of the user setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.onddo.service.impl.UserSettingLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 ...
 * @generated
 */
public abstract class UserSettingLocalServiceBaseImpl
	implements UserSettingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.onddo.service.UserSettingLocalServiceUtil} to access the user setting local service.
	 */
	...
	public UserSetting addUserSetting(UserSetting userSetting)
		...
		userSetting = userSettingPersistence.update(userSetting, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(userSetting);
			}
	 ...
	 */
	public UserSetting createUserSetting(long userSettingId) {
		return userSettingPersistence.create(userSettingId);
	}
	...
	public void deleteUserSetting(long userSettingId)
		...
		UserSetting userSetting = userSettingPersistence.remove(userSettingId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(userSetting);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSettingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userSettingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSettingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserSetting fetchUserSetting(long userSettingId)
		throws SystemException {
		return userSettingPersistence.fetchByPrimaryKey(userSettingId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserSetting getUserSetting(long userSettingId)
		throws PortalException, SystemException {
		return userSettingPersistence.findByPrimaryKey(userSettingId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userSettingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserSetting> getUserSettings(int start, int end)
		throws SystemException {
		return userSettingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserSettingsCount() throws SystemException {
		return userSettingPersistence.countAll();
	}
	...
	public UserSetting updateUserSetting(UserSetting userSetting)
		throws SystemException {
		return updateUserSetting(userSetting, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserSetting updateUserSetting(UserSetting userSetting, boolean merge)
		throws SystemException {
		userSetting.setNew(false);

		userSetting = userSettingPersistence.update(userSetting, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.onddo.model.UserSetting",
			userSettingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.onddo.model.UserSetting");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userSettingPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(UserSettingLocalServiceBaseImpl.class);
